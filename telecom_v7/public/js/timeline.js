...
frappe.ui.form.Timeline = Class.extend({
	...
	make: function() {
		...
		this.button = this.wrapper.find(".btn-go").on("click", function() {
		...
		this.email_check = this.wrapper.find(".timeline-head input[type='checkbox']").on("change", function() {
